...
<head>
    ...
    <title>SANAR + | Tratamientos</title>
...
<div class="max-w-7xl mx-auto">
    ...
    <h1 class="text-3xl font-extrabold text-[#2c3e50] mb-6 tracking-wide">Tabla de Tratamientos</h1>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="text-[#1a73e8] text-sm font-bold bg-white border-b border-gray-100">
                        ...
                        <th class="py-4 px-6">Diagnóstico</th>
                        <th class="py-4 px-6">Indicaciones</th>
                        <th class="py-4 px-6">Fecha Inicio</th>
                        <th class="py-4 px-6">Fecha Fin</th>
                ...
                <tbody class="text-sm text-gray-700 font-medium">
                    ...
                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                        <td class="py-4 px-6">{{ $tratamiento->id }}</td>
                        <td class="py-4 px-6">Diagnóstico #{{ $tratamiento->diagnosis_id }}</td>
                        <td class="py-4 px-6 max-w-xs truncate">{{ $tratamiento->{'general indications'} }}</td>
                        <td class="py-4 px-6">{{ $tratamiento->start_date }}</td>
                        <td class="py-4 px-6">{{ $tratamiento->end_date ?? 'En curso' }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="py-8 text-center text-gray-500">No hay tratamientos registrados aún.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
