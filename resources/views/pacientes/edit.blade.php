...
<head>
    ...
    <title>SANAR + | Editar Paciente</title>
...
<div class="max-w-3xl mx-auto">
    ...
    <h1 class="text-3xl font-extrabold text-[#2c3e50] mb-8 tracking-wide">Editar Paciente</h1>
        ...
        <form action="{{ route('pacientes.update', $paciente->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="surname" value="{{ old('surname', $paciente->surname) }}"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#5db7a1] transition" required>
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">DNI</label>
                    <input type="text" name="dni" value="{{ old('dni', $paciente->dni) }}" maxlength="8"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#5db7a1] transition" required>
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Teléfono</label>
                    <input type="text" name="telephone" value="{{ old('telephone', $paciente->telephone) }}"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#5db7a1] transition" required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $paciente->date_of_birth) }}"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#5db7a1] transition" required>
                </div>

                <div class="md:col-span-2">
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Dirección</label>
                    <input type="text" name="address" value="{{ old('address', $paciente->address) }}"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#5db7a1] transition" required>
                </div>
