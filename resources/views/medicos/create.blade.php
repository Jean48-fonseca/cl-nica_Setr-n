...
<head>
    ...
    <title>SANAR + | Nuevo Médico</title>
...
<div class="max-w-3xl mx-auto">
    ...
    <h1 class="text-3xl font-extrabold text-[#2c3e50] mb-8 tracking-wide">Agregar Nuevo Médico</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form action="{{ route('medicos.store') }}" method="POST">
            ...
            <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                ...
                <button type="submit" class="px-6 py-2.5 text-sm font-semibold text-white bg-[#1a73e8] hover:bg-[#1557b0] rounded-lg shadow-sm transition-colors">Guardar Médico</button>
            </div>
        </form>
    </div>
</div>
